...
<?php include 'header.php'?>
    ...
    <div class="text-center py-4" style="background-color:#ffffff " data-aos="fade-down">
      ...
      <p class="missiontext">Our mission is to create a world where every woman feels comfortable and confident.</p>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-6 col-sm-6 " data-aos="fade-left">
            <div class="card">
              <img
                src="https://cdn.shopify.com/s/files/1/0059/1592/products/20---Buttercream-WRP-BG-J-4_2834.jpg?v=1606579366&width=360"
                class="card-img-top"
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                  <button class="btn  instabtn me-2 w-50"><i class="fa-brands fa-instagram"></i></button>
