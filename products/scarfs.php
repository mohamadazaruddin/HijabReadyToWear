...
<div class="text-center">
      ...
      <p><a href="/HiJAbREADYTOWEAR/index.php">Home</a> <span> <i class="fa-solid fa-chevron-right"></i></span> Scarfs </p>
      </nav> 
      <div class="container d-block d-md-flex ">

      <a href="/HiJAbREADYTOWEAR/products/extensionsleeves.php" class='items_card my-4' data-aos="fade-down">
        ...
        <a href="/HiJAbREADYTOWEAR/products/pins.php" class='items_card my-4' data-aos="fade-down">
        <div class="items_card_image">
          <img class="fullImg" src="../images/magnetic_pins1.jpg" alt="" data-preload="" width='50px' height='50px'>
        </div>
        <div class="items_card_texts">
...
function addtocart(id) {
     fetch("../data/scarf.json").then(res => res.json()).then(data => {
      let itemsList = []
