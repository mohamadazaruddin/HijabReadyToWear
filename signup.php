...
if($username && $phoneno && $password && $email !== ""){
    if($num >= 1){
            echo '<div id="snackbar" class="bg-danger show" >user already exist</div>';
    }
    else{
 $result = mysqli_query($conn,$sql);
      echo ' <div id="snackbar" class="bg-success show" >Account Created succesfully</div>';
      header("location: login.php");
    }
  }
else{
    echo '<div id="snackbar" class="bg-danger show" >Missing Credentials</div>';
}
}
?>
...
<body>  
    ...
    <div class="maindiv py-5">
      <div class="login-box">
        <h2>Sign Up</h2>  
            <form action="/HijabReadyToWear/signup.php" method="post" id="contactForm">
                <div class="container">
                    <div class="input-div">
                    ...
                    <p class="signintext">Already have an Account ? <a href="login.php">Log in</a></p>
                </div>
            </form>
       </div>
    </div>
